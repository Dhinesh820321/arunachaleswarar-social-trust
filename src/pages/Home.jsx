        ...
        <section className="relative h-[95vh] flex items-center justify-center overflow-hidden bg-slate-900">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-20 text-center">
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-6 py-2 bg-primary/20 border border-primary/30 rounded-full text-primary-light font-semibold mb-8 backdrop-blur-md"
                >
                ...
                >
                    <Link to="/about" className="px-10 py-4 bg-primary text-white rounded-full font-bold hover:bg-primary-dark transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 group">
...
const StatCard = ({ icon: Icon, value, label, color }) => (
    ...
    >
        <div className={`absolute -top-4 -right-4 w-24 h-24 bg-${color}/10 rounded-full blur-2xl group-hover:scale-150 transition-transform`}></div>
        <div className={`p-4 bg-${color}/10 rounded-2xl mb-4 group-hover:bg-${color} group-hover:text-white transition-all text-${color}`}>
        ...
        <div>
            ...
            <section className="section-padding bg-white relative overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="w-full aspect-square bg-gradient-to-br from-primary/10 to-accent/10 rounded-[3rem] overflow-hidden rotate-3 relative z-10">
                            <img
                    ...
                    >
                        <div>
                            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-4">About the Trust</h2>
                            <h3 className="text-4xl font-extrabold text-slate-900 leading-tight">
                                Dedicated to Social Upliftment & <br /> Educational Excellence
                            </h3>
                        </div>
            ...
            <section className="section-padding bg-slate-50">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <StatCard icon={GraduationCap} value="5000" label="Students Impacted" color="primary" />
                    <StatCard icon={Users} value="1200" label="Women Empowered" color="accent" />
                    <StatCard icon={Sprout} value="800" label="Farmers Supported" color="secondary" />
                    <StatCard icon={Briefcase} value="300" label="Youth Skilled" color="primary" />
                </div>
            </section>
            ...
            <section className="section-padding py-0">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-primary-light text-lg max-w-2xl mx-auto mb-12">
                            Join our mission to create a more equitable and prosperous society. Your support can change lives.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <Link to="/contact" className="px-10 py-4 bg-white text-primary font-bold rounded-full hover:shadow-xl hover:shadow-black/20 transition-all transform hover:-translate-y-1">
                                Donate Now
                            </Link>
